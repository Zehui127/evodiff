...
import os
import urllib
from evodiff.dnadiff.constant import DNA_ALPHABET, DNA_GAP, DNA_MSA_AAS
...
class Tokenizer(object):
    ...
    def __init__(self, protein_alphabet=DNA_ALPHABET, pad=MSA_PAD, mask=MASK, all_aas=DNA_MSA_AAS, gap=DNA_GAP, start=START,
        ...
        #------------------------------------------------------
        # the below line is strange, remove for now
    ...
    def one_hot(self, tokenized):
        ...
        # print(tokenized, torch.max(tokenized),self.K)
